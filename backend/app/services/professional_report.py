...
Отвечай ТОЛЬКО валидным JSON массивом без markdown."""
    ...
    def _create_recommendations_section_ai(
        ...
        story.append(Paragraph("ЗАКЛЮЧЕНИЕ", self._styles['SectionTitle']))
        story.append(Paragraph(
            "Данный отчёт содержит результаты комплексного тестирования безопасности. "
            "Все выводы и рекомендации основаны на обнаруженных уязвимостях и лучших практиках "
            "информационной безопасности.<br/><br/>"
            "Для полной оценки защищённости рекомендуется провести дополнительное ручное "
            "тестирование на проникновение квалифицированными специалистами.",
            self._styles['CustomBody']
        ))
