  ...
  const features = [
    {
      ...
      description: 'DeepSeek LLM generates intelligent hypotheses and validates vulnerabilities with real PoC.',
    },
    {
      icon: <BoltIcon />,
      title: 'Two-Stage Scanning',
      description: 'Stage 1: Automated tools (nmap, nuclei, httpx). Stage 2: AI-driven deep analysis.',
    },
    {
      icon: <ShieldIcon />,
      title: 'Compliance First',
      description: 'Every action validated against program rules. No destructive operations, ever.',
    },
    {
      icon: <ChartIcon />,
      title: 'Full Audit Trail',
      description: 'Complete transparency: every AI decision logged with reasoning and evidence.',
    },
    {
      icon: <LockIcon />,
      title: 'Supervised Mode',
      description: 'Approve each test before execution. Full control over AI actions.',
    },
    {
      icon: <ClockIcon />,
      title: 'Rate Limiting',
      description: 'Configurable request limits. Respect target systems and program rules.',
    },
  ];

  const pricingFeatures = [
    'Unlimited programs',
    'AI-Driven Stage 2 scanning',
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
              AI-driven vulnerability scanner that thinks like a hacker. 
              Automated reconnaissance, intelligent hypothesis generation, 
              and real proof-of-concept validation.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-slate-500 mt-1">Vulnerability Types</div>
              </div>
              <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Powered by advanced AI and battle-tested security tools
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Two-stage intelligent scanning process
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold mb-4 mt-4">Stage 1: Reconnaissance</h3>
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>Port scanning with nmap</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon />
                ...
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>Nuclei template scanning</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>HTTP header analysis</span>
                </li>
              </ul>
            </div>
            ...
            <div className="relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold mb-4 mt-4">Stage 2: AI Analysis</h3>
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>AI hypothesis generation</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>Targeted vulnerability testing</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon />
                  <span>Real PoC validation</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon />
      ...
      <section id="pricing" className="py-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-lg mx-auto">
            <div className="relative p-8 bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-blue-500/30 rounded-3xl shadow-2xl shadow-blue-500/10">
              ...
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-2">Pay Per Request</h3>
                <div className="flex items-baseline justify-center gap-1">
                  ...
                  <span className="text-slate-400">/ AI request</span>
                </div>
                <p className="text-slate-500 mt-2">Stage 1 scanning is free</p>
              </div>
              ...
              <p className="text-center text-slate-500 text-sm mt-4">
                No credit card required • Start with 100 free AI requests
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-400 mb-4">Need custom limits or on-premise deployment?</p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/30 rounded-3xl">
            ...
            <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
              Join security researchers and companies who trust BugHunter AI 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 text-slate-400">
              ...
              <a href="mailto:support@bughunter.ai" className="hover:text-white transition-colors">Support</a>
            </div>
            <div className="text-slate-500">
              © 2026 BugHunter AI. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
